---
name: copy.plain-language
description: Enforces plain, user-facing language and blocks jargon-heavy product copy. Use when UI text drifts into buzzwords, metaphors, or internal terminology that users should not see.
